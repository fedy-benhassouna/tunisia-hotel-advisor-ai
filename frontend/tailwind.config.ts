		...
		extend: {
			colors: {
				...
				tunisia: {
					...
					'blue-light': 'hsl(var(--tunisia-blue-light))',
					sand: 'hsl(var(--tunisia-sand))',
					terracotta: 'hsl(var(--tunisia-terracotta))',
					olive: 'hsl(var(--tunisia-olive))'
				},
				sidebar: {
			...
			backgroundImage: {
				...
				'gradient-mediterranean': 'var(--gradient-mediterranean)'
			},
			boxShadow: {
